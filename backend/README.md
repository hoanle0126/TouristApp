...
```json
{
  ...
  "alt": "Tour image alt text",
  "heroImage": "https://example.com/tour-hero.jpg",
  "heroAlt": "Tour hero alt text",
  "curatorImage": "https://example.com/curator.jpg",
  "curatorImageAlt": "Curator portrait alt text",
...
```json
{
  ...
  "scoreSummary": "Hotel score summary.",
  "status": "published",
