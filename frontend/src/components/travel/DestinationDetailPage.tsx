...
function Overview({ detail }: Readonly<{ detail: DestinationDetail }>) {
  return (
    <section className="grid grid-cols-1 gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
      <div>
        <h2 className="mb-8 text-sm font-bold uppercase tracking-[0.3em] text-red-800">Destination Overview</h2>
      ...
      <div className="rounded-[1.75rem] bg-stone-100 p-8 md:p-10">
        <h2 className="mb-6 text-sm font-bold uppercase tracking-[0.3em] text-red-800">Planning Facts</h2>
...
function Spotlight({ detail }: Readonly<{ detail: DestinationDetail }>) {
  return (
    <section>
      <h2 className="mb-10 text-sm font-bold uppercase tracking-[0.3em] text-red-800">Why It Works</h2>
  ...
  return (
    <section>
      <div className="rounded-[2.5rem] bg-stone-950 px-8 py-14 text-white md:px-12 lg:px-16">
        <p className="mb-4 text-xs font-black uppercase tracking-[0.3em] text-red-200">Next Step</p>
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <Button asChild className="rounded-full bg-white px-8 text-xs uppercase tracking-widest text-stone-950 hover:bg-red-100">
            <Link href={href}>
              Build itinerary
              <ArrowRight className="size-4" />
            </Link>
